...
public class UsernameTest {
    ...
    private static final String[] SVART_USERNAMES = {
        "Svarträv", "SVARTRÄV", "SvarträV", "svartrÄv", "svarträv"
    };

    private static Stream<Arguments> usernameShouldBeCaseInsensitive() {
        return Stream.of(
                Arguments.of("Z-DNA", ZDNA_USERNAMES), Arguments.of("Svarträv", SVART_USERNAMES));
    }

    @ParameterizedTest
    @MethodSource
    public void usernameShouldBeCaseInsensitive(
            String exemplaryUsernameString, String[] usernameStrings) {
